        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.a_fb :
                    try {
                        getActivity().getPackageManager().getPackageInfo("com.facebook.katana", 0);
                        intent = new Intent(Intent.ACTION_VIEW, Uri.parse("fb://profile/" + FB_A_ID));
                    } catch (Exception ex) {
                        intent = new Intent(Intent.ACTION_VIEW, Uri.parse(FB_A_URL));
                    }
                    break;
                ...
                case R.id.a_twit :
                    try {
                        getActivity().getPackageManager().getPackageInfo("com.twitter.android", 0);
                        intent = new Intent(Intent.ACTION_VIEW, Uri.parse("twitter://user?user_id=" + TWIT_A_ID));
                    } catch (Exception ex) {
