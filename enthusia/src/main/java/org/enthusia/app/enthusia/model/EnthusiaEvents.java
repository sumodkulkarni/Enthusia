...
public final class EnthusiaEvents {
    ...
    public static String[] getEventHead (int position) {
        switch (position) {
            case 0: // Cricket
                return new String[] { "Anklesh Shekoker: +917387438280", "Smitesh Modak: +919769604373", "Devansh Khaitan: +919167426373", "Abhijit Gupta: +918879433235" };
            case 1: // Football
            ...
            case 3: // Volleyball
                return new String[] { "Prashant Sanap: +917709402238", "Ajinkya Palwe: +919404323538", "Rutuja Karampure: +919769951513", "Neha Chavan: +918879820967" };
            ...
            case 5: // Tennis
                return new String[] { "Raghav Agrawal: +919321331848", "Sherin Parmar: +9196192480070", "Darmik: +919167603322", "Prashita Pratapan: +919757341789", "Sharvika Kotre: +919821025567" };
            case 6: // Table Tennis
            ...
            case 8: // Athletics
                return new String[] { "Kshitij Agrawal: +919405470077", "Tejas Katkade: +919975513952", "Deep Gala: +918097157686", "Priya Masne: +918806209812", "Ankita Borhade: +918286334264" };
            case 9: // Throwball
            ...
            case 16: // Kho Kho
                return new String[] { "Sanket Giri: +918446977134", "Praful Khobragade: +919892602353", "Akshata Hire: +917208307426", "Pradnya Shivsharan: +918976442036" };
            case 17: // Swimming
                return new String[] { "Chinmay Karmalkar: +919820855892", "Abhijit Gupta: +918879433235", "Abraham George: +919619823690", "Ashwini Bhosle: +919029391087" };
            case 18: // Marathon
